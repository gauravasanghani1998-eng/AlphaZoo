...
/// A–Z grid inside Trace & Write → Alphabets.
class LetterTraceAlphabetScreen extends StatelessWidget {
  const LetterTraceAlphabetScreen({super.key});
              ...
              itemBuilder: (context, index) {
                ...
                return AlphabetTile(
                  ...
                  onTap: () {
                    ...
                    AppSpeech.speak(
                      context,
                      'letterTrace.speakStart'.tr(
                        namedArgs: {'letter': item.letter},
                      ),
                    );
                    Navigator.of(context).push(
                      PageRouteBuilder(
                        pageBuilder: (context, animation, secondaryAnimation) =>
                          ...
                          kind: TracePracticeKind.alphabet,
                          initialIndex: index,
                        ),
                        transitionsBuilder:
